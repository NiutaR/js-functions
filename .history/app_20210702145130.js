...
const answerMyQuestion = userName, userQuestion  => ({
    eightBall: 'It is certain', eightBall: 'It is decidedly so', eightBall: 'Reply hazy try again', eightBall: 'Cannot predict now', eightBall: 'Do not count on it', eightBall 
})
